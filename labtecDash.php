  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Lab Technician Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <p>Lab request Infromation</p>
              </div>
              <div class="icon">
                <i class="ion ion-pull-request"></i>
              </div>
              <a href="labtecrequestlist.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
