  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Required Equipment List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-warning card-outline">
              <div class="card-header">
                <div class="card-fbody">
                    ...
                    <a href="adminReportDamaged.php" class="btn btn-success" role="button" ><span title="Go Back">Generate Report</span></a>
                </div>
              </div>
