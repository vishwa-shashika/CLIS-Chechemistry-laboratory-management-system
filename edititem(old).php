    ...
    if(isset($_GET['id'])){
        ...
        echo'
            ...
            <div class="card-body">
                ...
                <input type="text" class="form-control" name="txt_item" placeholder="Enter Item Name" value="'.$row->item_name.'" required>
            </div>
        ...
        while($row_cat=$select->fetch(PDO::FETCH_ASSOC)){
            echo '<option>'.$row_cat['category'].'</option>';
        ...
        echo '
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="1" step="1" class="form-control" name="txt_istock" placeholder="Enter Ideal Stock" value="'.$row->ideal_stock.'" required>
                  </div>
                    
                  <div class="form-group">
                    <label>Current Stock</label>
                    <input type="number" min="0" step="1" class="form-control" name="txt_cstock" placeholder="Enter Current Stock" value="'.$row->current_stock.'" required>
                  </div>
 ...
 <!--===================================Right Side Start ======================================-->
          ...
          <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_location" placeholder="Enter Location" value="'.$row->location.'" required>
                </div>
                
                    
                <div class="form-group">
                    <label>Item Description</label>
                    <textarea class="form-control" rows="4" name="txt_desc" placeholder="Enter Item Description ..." >'.$row->description.'</textarea>
                 </div>
